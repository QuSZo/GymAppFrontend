  ...
  return (
    <div className={styles.main}>
      <p className={styles.mainDate}>
        {props.date.toLocaleDateString("pl-PL", { weekday: "short" })}
      </p>
      <button
        onClick={() => props.onClick(props.date)}
        className={cn(
          styles.mainShield,
          props.selected ? styles.mainShieldSelected : undefined,
        )}
      >
        <div
          className={cn(
            styles.mainShieldContent,
            props.selected ? styles.mainShieldContentSelected : undefined,
          )}
        >
